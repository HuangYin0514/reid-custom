...
from .pcb_branch import PCB_Branch
...
class PCB(nn.Module):
    ...
    def __init__(self,
        ...
        # backbone--------------------------------------------------------------------------
        self.backbone = PCB_Branch(pretrained=pretrained, last_stride=last_stride,
                                   height=height, width=width, model_path=model_path)
