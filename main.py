...
parser.add_argument('--experiment', type=str, default='pcb_gloab')
...
parser.add_argument('--test_other_dataset', type=str, default='Occluded_REID123')
...
if __name__ == "__main__":
    ...
    print(args.test_other_dataset)
    test_loader, test_query_loader, test_gallery_loader, test_num_classes = getDataLoader(args.test_other_dataset, args.test_other_dataset_path, args=args)
