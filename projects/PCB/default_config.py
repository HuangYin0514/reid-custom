...
def get_default_config():
    ...
    # pcb setting
    cfg.model.num_stripes = 6  # num_stripes  blocks
    cfg.model.share_conv = False  # share conv
    cfg.model.return_features = False  # return features
...
def model_kwargs(cfg):
    return {
        ...
        'share_conv': cfg.model.share_conv,
        'return_features': cfg.model.return_features,
    }
